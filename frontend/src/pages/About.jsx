  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Shubham excels in
      ...
      <p>
        ...
        React.js and Vue.js. Skilled in HTML5, CSS3, and responsive
        ...
        Express.js, and MongoDb. Experienced with database management using SQL
      ...
      <br />
      <span>
      Shubham K is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Shubham is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>Akshay.</strong> Their friendly rivalry and deep bond have
        significantly shaped Shubham's journey. Akshay is not only a great
        competitor but also a steadfast friend, constantly motivating Shubham to
